...
exports.machinesGetV1MachinesMachineId = machinesGetV1MachinesMachineId;
 ...
 */
async function machinesGetV1MachinesMachineId(client$, request, options) {
    const input$ = request;
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.GetV1MachinesMachineIdRequest$outboundSchema.parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
...
//# sourceMappingURL=machinesGetV1MachinesMachineId.js.map