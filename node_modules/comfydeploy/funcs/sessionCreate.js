 ...
 * Create Session
 */
async function sessionCreate(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => components.CreateSessionBody$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
