...
exports.machinesPostV1Machines = machinesPostV1Machines;
 ...
 */
async function machinesPostV1Machines(client$, request, options) {
    const input$ = request;
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.PostV1MachinesRequestBody$outboundSchema.optional().parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
...
//# sourceMappingURL=machinesPostV1Machines.js.map