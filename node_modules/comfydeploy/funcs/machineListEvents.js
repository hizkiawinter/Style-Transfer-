...
exports.machineListEvents = machineListEvents;
 ...
 */
async function machineListEvents(client, request, options) {
    const input = request;
    const parsed = (0, schemas_js_1.safeParse)(input, (value) => operations.GetMachineMachineIdEventsRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
        return parsed;
    }
...
//# sourceMappingURL=machineListEvents.js.map