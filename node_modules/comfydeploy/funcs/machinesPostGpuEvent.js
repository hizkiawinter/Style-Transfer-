...
exports.machinesPostGpuEvent = machinesPostGpuEvent;
 ...
 */
async function machinesPostGpuEvent(client$, request, options) {
    const input$ = request;
    const parsed$ = schemas$.safeParse(input$, (value$) => operations.PostGpuEventRequestBody$outboundSchema.optional().parse(value$), "Input validation failed");
    if (!parsed$.ok) {
        return parsed$;
    }
...
//# sourceMappingURL=machinesPostGpuEvent.js.map