...
export type RootApiStatusUpdateRequestBody = {
    status: Status;
    liveStatus: string;
    progress: number;
    runId: string;
...
/** @internal */
export declare const RootApiStatusUpdateRequestBody$inboundSchema: z.ZodType<RootApiStatusUpdateRequestBody, z.ZodTypeDef, unknown>;
/** @internal */
export type RootApiStatusUpdateRequestBody$Outbound = {
    status: string;
    live_status: string;
    progress: number;
    run_id: string;
...
/** @internal */
export declare const RootApiStatusUpdateRequestBody$outboundSchema: z.ZodType<RootApiStatusUpdateRequestBody$Outbound, z.ZodTypeDef, RootApiStatusUpdateRequestBody>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace RootApiStatusUpdateRequestBody$ {
    /** @deprecated use `RootApiStatusUpdateRequestBody$inboundSchema` instead. */
    const inboundSchema: z.ZodType<RootApiStatusUpdateRequestBody, z.ZodTypeDef, unknown>;
    /** @deprecated use `RootApiStatusUpdateRequestBody$outboundSchema` instead. */
    const outboundSchema: z.ZodType<RootApiStatusUpdateRequestBody$Outbound, z.ZodTypeDef, RootApiStatusUpdateRequestBody>;
    /** @deprecated use `RootApiStatusUpdateRequestBody$Outbound` instead. */
    type Outbound = RootApiStatusUpdateRequestBody$Outbound;
}
//# sourceMappingURL=rootapistatusupdate.d.ts.map