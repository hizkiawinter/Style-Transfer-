...
exports.PostV1MachinesResponseBody$ = exports.PostV1MachinesResponseBody$outboundSchema = exports.PostV1MachinesResponseBody$inboundSchema = exports.PostV1MachinesResponseBody = void 0;
const z = __importStar(require("zod"));
/**
 * Error in creating machine
 */
class PostV1MachinesResponseBody extends Error {
    constructor(err) {
...
exports.PostV1MachinesResponseBody = PostV1MachinesResponseBody;
/** @internal */
...
/** @internal */
exports.PostV1MachinesResponseBody$outboundSchema = z.instanceof(PostV1MachinesResponseBody)
    .transform(v => v.data$)
    .pipe(z.object({
    error: z.string(),
}));
