...
exports.PostRunResponseBody$ = exports.PostRunResponseBody$outboundSchema = exports.PostRunResponseBody$inboundSchema = exports.PostRunResponseBody = void 0;
const z = __importStar(require("zod"));
/**
 * Error creating run
 */
class PostRunResponseBody extends Error {
    constructor(err) {
...
exports.PostRunResponseBody = PostRunResponseBody;
/** @internal */
...
/** @internal */
exports.PostRunResponseBody$outboundSchema = z.instanceof(PostRunResponseBody)
    .transform(v => v.data$)
    .pipe(z.object({
    error: z.string(),
}));
