...
exports.PostGpuEventResponseBody$ = exports.PostGpuEventResponseBody$outboundSchema = exports.PostGpuEventResponseBody$inboundSchema = exports.PostGpuEventResponseBody = void 0;
const z = __importStar(require("zod"));
/**
 * Error creating run
 */
class PostGpuEventResponseBody extends Error {
    constructor(err) {
...
exports.PostGpuEventResponseBody = PostGpuEventResponseBody;
/** @internal */
...
/** @internal */
exports.PostGpuEventResponseBody$outboundSchema = z.instanceof(PostGpuEventResponseBody)
    .transform(v => v.data$)
    .pipe(z.object({
    error: z.string(),
}));
