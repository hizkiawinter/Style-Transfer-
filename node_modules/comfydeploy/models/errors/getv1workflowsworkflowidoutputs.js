...
exports.GetV1WorkflowsWorkflowIdOutputsResponseBody$ = exports.GetV1WorkflowsWorkflowIdOutputsResponseBody$outboundSchema = exports.GetV1WorkflowsWorkflowIdOutputsResponseBody$inboundSchema = exports.GetV1WorkflowsWorkflowIdOutputsResponseBody = void 0;
const z = __importStar(require("zod"));
/**
 * Error in retrieving the specific workflow
 */
class GetV1WorkflowsWorkflowIdOutputsResponseBody extends Error {
    constructor(err) {
...
exports.GetV1WorkflowsWorkflowIdOutputsResponseBody = GetV1WorkflowsWorkflowIdOutputsResponseBody;
/** @internal */
...
/** @internal */
exports.GetV1WorkflowsWorkflowIdOutputsResponseBody$outboundSchema = z.instanceof(GetV1WorkflowsWorkflowIdOutputsResponseBody)
    .transform(v => v.data$)
    .pipe(z.object({
    error: z.string(),
}));
