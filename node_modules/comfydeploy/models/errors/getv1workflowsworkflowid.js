...
exports.GetV1WorkflowsWorkflowIdResponseBody$ = exports.GetV1WorkflowsWorkflowIdResponseBody$outboundSchema = exports.GetV1WorkflowsWorkflowIdResponseBody$inboundSchema = exports.GetV1WorkflowsWorkflowIdResponseBody = void 0;
const z = __importStar(require("zod"));
/**
 * Error in retrieving the specific workflow
 */
class GetV1WorkflowsWorkflowIdResponseBody extends Error {
    constructor(err) {
...
exports.GetV1WorkflowsWorkflowIdResponseBody = GetV1WorkflowsWorkflowIdResponseBody;
/** @internal */
...
/** @internal */
exports.GetV1WorkflowsWorkflowIdResponseBody$outboundSchema = z.instanceof(GetV1WorkflowsWorkflowIdResponseBody)
    .transform(v => v.data$)
    .pipe(z.object({
    error: z.string(),
}));
